...
class MenuMaterias:
    def __init__(self):
        ...
        btn_agregar_materias = ctk.CTkButton(self.columna_2, text="Agregar\nMaterias", font=('Helvetica', 30, 'bold'),
                                             ...
                                             command=lambda: destruir(self.ventana, self.abrir_agregar_materias))
    ...
    def abrir_agregar_materias(self):
        # Aquí se abre la ventana de "Agregar Materias"
        print("Se abre la ventana de Agregar Materias")
