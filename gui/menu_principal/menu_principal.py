...
class MenuPrincipal:
    def __init__(self):
        ...
        self.frame_botones.grid_rowconfigure(0, weight=1)  # Primera fila para las columnas
        self.frame_botones.grid_rowconfigure(1, weight=0)  # Segunda fila para el botón adicional
       ...
       # Primera columna (Azul)
        ...
        btn_alumnos.place(relx=0.5, rely=0.5, anchor="center", relwidth=1, relheight=1)  # Ocupa todo el Frame
        ...
        btn_materias.place(relx=0.5, rely=0.5, anchor="center", relwidth=1, relheight=1)  # Ocupa todo el Frame
        ...
        btn_faltas.place(relx=0.5, rely=0.5, anchor="center", relwidth=1, relheight=1)  # Ocupa todo el Frame
        ...
        btn_amonestaciones.place(relx=0.5, rely=0.5, anchor="center", relwidth=1, relheight=1)  # Ocupa todo el Frame


        # Botón adicional para Notas
        btn_notas = ctk.CTkButton(self.frame_botones, text="Notas", font=('Helvetica', 30, 'bold'),
                          text_color="#FFFFFF", fg_color="#6F42C1", hover_color="#7D5BA6",
                          command=lambda: destruir(self.ventana, MenuNotas))
        btn_notas.grid(row=1, column=0, columnspan=4, sticky="nsew", padx=10, pady=10)
